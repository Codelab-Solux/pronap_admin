...
urlpatterns = [
    ...
    # ------------------------------
    path('stock/ops/details/<hashid:pk>/',
         stock_ops_details, name='stock_ops_details'),
    path('stock/ops/edit/<hashid:pk>/', edit_stock_ops, name='edit_stock_ops'),
    path('stock/ops/create/<str:pk>/', create_stock_ops, name='create_stock_ops'),
    ...
    path('sales/<hashid:pk>/transactions/create/',
         create_sale_transaction, name='create_sale_transaction'),
    # ----------------------------------------------------------------------------
    ...
    # --------------------------
    path('purchases/<hashid:pk>/create/transaction/',
         create_purchase_transaction, name='create_purchase_transaction'),
    ...
    path('parameters/categories/list/', categories_list, name='categories_list'),
    path('parameters/categories/create/', create_category, name='create_category'),
    path('parameters/categories/<hashid:pk>/edit/', edit_category, name='edit_category'),
    # --------------------------
    path('parameters/lots/list/', lots_list, name='lots_list'),
    path('parameters/lots/create/', create_lot, name='create_lot'),
    path('parameters/lots/<hashid:pk>/', lot_details, name='lot_details'),
    path('parameters/lots/<hashid:pk>/edit/', edit_lot, name='edit_lot'),
    # --------------------------
    path('parameters/families/load/', load_families, name='load_families'),
    path('parameters/families/list/', families_list, name='families_list'),
    path('parameters/families/create/', create_family, name='create_family'),
    path('parameters/families/<hashid:pk>/edit/',
    ...
    path('finances/transactions/create/<hashid:pk>/desk/',
         create_desk_transaction, name='create_desk_transaction'),
    # --------------------------
    path('finances/transactions/create/', create_transaction, name='create_transaction'),
    path('finances/transactions/list/', transactions_list, name='transactions_list'),
    path('finances/transactions/store/<hashid:pk>/', store_transactions, name='store_transactions'),
    path('finances/transactions/<hashid:pk>/',
         transaction_details, name='transaction_details'),
    path('finances/transactions/<hashid:pk>/edit/',
         edit_transaction, name='edit_transaction'),
